...
type View = 'dashboard' | 'transactions' | 'send-money' | 'settings';
...
const BANKS = [
  ...
  'Capital One', 'TD Bank', 'Bank of New York Mellon', 'State Street', 'American Express', 
  'Citizens Financial Group', 'First Citizens Bank', 'Silicon Valley Bank', 'Fifth Third Bank', 
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col">
      <header className="h-16 border-b border-white/10 flex items-center justify-between px-6 bg-[#0A0A0A] z-30">
        ...
        <div className="relative"><button onClick={() => setIsProfilePopupOpen(!isProfilePopupOpen)} className="w-10 h-10 bg-white/10 roun
